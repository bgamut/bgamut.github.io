...
// **************************************************************************************************
// Linklok URL V3.2
// Copyright (c) 2003-2017 Vibralogix
// www.vibralogix.com
...
// General settings
$LinklokKey="livinginthefuture";   															// Set to random string used to encrypt links
$LinklokLocation="http://www.squwbs.com/files/INIT.zip/"; 			      // Location where files are securely stored
$ManualPassword="letmein";                                  // password used to access manual entry form
...
$YourCompany="Squwbs";																// Your company name
$YourEmail="bernardahn@squwbs.com";          	                // Your email address
$CopyEmail="bgamut@gmail.com";                                              // Set an email address if you want to receive copies of emails sent to users
...
{
  if (false!==array_search(strtolower($namepair),$checkvar))
    $found=true;
}
reset($_POST);
...
reset($_COOKIE);
while(list($namepair, $valuepair) = each($_COOKIE))
{
  if (false!==array_search(strtolower($namepair),$checkvar))
    $found=true;
}
...
if (($ManualPassword!="") && ($ManualPassword==$linklokpassword))
{
  ...
  if ($newexpiry1=="10080")
    ...
    print "<option value=\"10800\">7 Days</option>\n";
  if ($newexpiry1=="43200")
...
function linklokgetfile($linklokauth)
{
  ...
  if (substr(trim(strtolower($link)),0,3)=="s3|")
  {
    ...
    $url=linklokget_s3_url($link,time()+$ServerTimeAdjust,"GET",$dialog,$actualfname);
    header("Location: ".$url);
    exit;
  }
  ...
  if (substr(trim(strtolower($link)),0,3)=="db|")
  {
    ...
    if ($LinklokDownloadLog!="")
      linkloklogdownload($LinklokDownloadLog,$actualfname,$id);      
    $url=linklokget_db_url($link,$dialog,$actualfname);
    header("Location: ".$url);
    exit;
  }
...
if ($NotifyEmail!="")
{
  if (($NotifyEmail!="") && (strtolower($NotifyEmail)!="none"))
  {
    if (function_exists('vl_geoip2'))
  ...
  if (count($groupstouse)>0)
  {
    ...
    if ((linklokvalidemail($clientemail)) && (isset($_REQUEST['name'])) && ($_REQUEST['name']!=""))
    {
      ...
      else
      {
        ...
        $exists=slapi_getuser($clientemail, $created, $pass, $en, $nm, $em, $ugs, $cus1, $cus2, $cus3, $cus4, $cus5, $cus6, $cus7, $cus8, $cus9, $cus10,
                        $cus11, $cus12, $cus13, $cus14, $cus15, $cus16, $cus17, $cus18, $cus19, $cus20,$cus21, $cus22, $cus23, $cus24, $cus25, $cus26, $cus27, $cus28, $cus29, $cus30,
                        $cus31, $cus32, $cus33, $cus34, $cus35, $cus36, $cus37, $cus38, $cus39, $cus40,$cus41, $cus42, $cus43, $cus44, $cus45, $cus46, $cus47, $cus48, $cus49, $cus50);
        if ($exists==0)
        { 
      ...
      if ($exists==1)
      {
        ...
        slapi_modifyuser($username,$pass,$en,$nm,$em,$modgroups,"","",1,$cus1,$cus2,$cus3,$cus4,$cus5,$cus6,$cus7,$cus8,$cus9,$cus10,
             $cus11,$cus12,$cus13,$cus14,$cus15,$cus16,$cus17,$cus18,$cus19,$cus20,
             $cus21,$cus22,$cus23,$cus24,$cus25,$cus26,$cus27,$cus28,$cus29,$cus30,
             $cus31,$cus32,$cus33,$cus34,$cus35,$cus36,$cus37,$cus38,$cus39,$cus40,
             $cus41,$cus42,$cus43,$cus44,$cus45,$cus46,$cus47,$cus48,$cus49,$cus50);
      }  
      else
      {
        for ($k=0;$k<count($sc);$k++)
        ...
        slapi_addorupdate($username,$pass,$clientemail,$name,$groups,$groupexpiries,"","","","",1,$cus1, $cus2, $cus3, $cus4, $cus5, $cus6, $cus7, $cus8, $cus9, $cus10,
                        $cus11, $cus12, $cus13, $cus14, $cus15, $cus16, $cus17, $cus18, $cus19, $cus20,$cus21, $cus22, $cus23, $cus24, $cus25, $cus26, $cus27, $cus28, $cus29, $cus30,
                        $cus31, $cus32, $cus33, $cus34, $cus35, $cus36, $cus37, $cus38, $cus39, $cus40,$cus41, $cus42, $cus43, $cus44, $cus45, $cus46, $cus47, $cus48, $cus49, $cus50);
      }  
    }
...
function linklokfilename($fname)
{
  if ($fname == "")
    return("");
  // First see if link is for S3 or Dropbox
...
function linklokget_s3_url($location,$expires,$operation="GET",$dialog=0,$newname="")
{
  ...
  if ($sigver==2)
  {
    ...
    $final_url = "http://$bucket.s3.amazonaws.com/$resource?";
    $append_char = '?';
